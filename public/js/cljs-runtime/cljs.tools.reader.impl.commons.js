...
var G__27488 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__27488;
continue;
} else {
return ch;
...
var vec__27474 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27474,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq27481){
...
return (function() { 
var G__27500__delegate = function (rdr,_){
...
var G__27500 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__27501__i = 0, G__27501__a = new Array(arguments.length -  1);
while (G__27501__i < G__27501__a.length) {G__27501__a[G__27501__i] = arguments[G__27501__i + 1]; ++G__27501__i;}
  _ = new cljs.core.IndexedSeq(G__27501__a,0,null);
} 
return G__27500__delegate.call(this,rdr,_);};
G__27500.cljs$lang$maxFixedArity = 1;
G__27500.cljs$lang$applyTo = (function (arglist__27502){
var rdr = cljs.core.first(arglist__27502);
var _ = cljs.core.rest(arglist__27502);
return G__27500__delegate(rdr,_);
});
