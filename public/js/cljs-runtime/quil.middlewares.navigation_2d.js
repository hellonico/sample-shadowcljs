...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3((user_setup.cljs$core$IFn$_invoke$arity$0 ? user_setup.cljs$core$IFn$_invoke$arity$0() : user_setup.call(null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611)], null),((function (initial_state){
return (function (p1__36488_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__36488_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_36507 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_36508 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_36507);
var pos_36509 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_36507);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_36508);

var tr__36393__auto___36510 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_36508) - cljs.core.first(pos_36509)),(((quil.core.height() / (2)) / zoom_36508) - cljs.core.second(pos_36509))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__36393__auto___36510);
...
var G__36493 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__36494 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__36493,G__36494) : user_mouse_dragged.call(null,G__36493,G__36494));
...
return (function (state,event){
var G__36495 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__36496 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__36495,G__36496) : user_mouse_wheel.call(null,G__36495,G__36496));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
